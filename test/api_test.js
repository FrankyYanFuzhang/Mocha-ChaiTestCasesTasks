...
var Valid = {
    ...
    "case-7.2": [
        { "id": testID, "name": " axdmin\" oxr x1=1x oxr \"\"=\"" },
        { "id": testID, "name": " adxmin\" oxr 1=1x oxr \"\"=\"" },
        { "id": testID, "name": " admixn\" oxr 1=1x oxr \"\"=\"" },
    ],
    "case-8.2": [
    ...
    "case-18.2": [
        ...
        { "id": testID, "name": ",(xselxect * from (selecxt(sxleep(10)))a)" },
    ],
    "case-19.2": [
    ...
    "case-21.2": [
        ...
        { "id": testID, "name": "ANDx (xSELExCT * FROM (SELECxT(SxLEEP(5)))bAKL) ANxD 'vRxe'=x'vRxe" },
    ],
    "case-22.2": [
    ...
    "case-40.2": [
        ...
        { "id": testID, "name": "AxND (xSELxECT * FROM (SELECxT(SxLEEP(5)))nQIP)-x-" },
    ],
    "case-41.2": [
    ...
    "case-67.2": [
        ...
        { "id": testID, "name": "AxND (xSELxECT * FROM (SxELECT(SxLEEP(5)))bAKL) xANDx 'vRxe'=x'vRxe" },
    ],
    "case-68.2": [
